...
public class OI {
    ...
    public OI() {
        ...
        joystickButton8 = new JoystickButton(gamepad, 8);
        joystickButton8.whenPressed(new Reload());
        ...
        joystickButton7 = new JoystickButton(gamepad, 7);
        joystickButton7.whenPressed(new Fire());
